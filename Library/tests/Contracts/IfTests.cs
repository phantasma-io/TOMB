...
contract test {
    public sign(x:number, name:string): number {
		...
		Assert.IsTrue(vm.Stack.Count == 1);
		var val = vm.Stack.Pop().AsNumber();
		Assert.That(val, Is.EqualTo((BigInteger)1));
		...
		Assert.That(val, Is.EqualTo((BigInteger)5));
		...
		val = vm.Stack.Pop().AsNumber();
		Assert.That(val, Is.EqualTo((BigInteger)10));
		...
		val = vm.Stack.Pop().AsNumber();
		Assert.That(val, Is.EqualTo((BigInteger)0));
