...
{
	/// <summary>
	/// Assembler argument parser helpers (registers, labels, literals).
	/// NOTE: alias state is static, so each compile pass must call ClearAlias().
	/// </summary>
	public static class ArgumentUtils
	{
		...
		// Alias -> register map used while processing a single script.
